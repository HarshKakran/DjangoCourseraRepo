    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Enter a make (e.g. Hyundai)', max_length=200, validators=[django.core.validators.MinLengthValidator(2, 'Please enter 2 or more characters')])),
            ],
        ),
        migrations.CreateModel(
            name='Auto',
